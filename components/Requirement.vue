  ...
  <section class="requirement-section">
    <div class="container mx-auto my-16">
      ...
      <ul class="px-5 md:px-0 md:pl-20">
       ...
       <li class="consulting-list-item-child">Навыки работы в команде и коммуникабельность </li>
      </ul>
    </div>
    ...
    <div class="bg-white container mx-auto my-16">
      ...
      <ul class="px-5 md:px-0 md:pl-20">
       ...
       <li class="consulting-list-item-child">Хорошее вознаграждение: оклад + прозрачная мотивация (процент от продаж услуг компании)</li>
       <li class="consulting-list-item-child">Зарплата два раза в месяц 50% оклада + 50% оклада и бонусы</li>
       <li class="consulting-list-item-child">Годовой бонус! Тринадцатая зарплата!</li>
       <li class="consulting-list-item-child">Работа в команде профессионалов, мы готовы помочь на каждом этапе</li>
       <li class="consulting-list-item-child">Возможность карьерного роста</li>
       <li class="consulting-list-item-child">График 5/2, праздничные дни – выходные </li>
      </ul>
    </div>
