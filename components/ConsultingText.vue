...
Вдохновляя клиентов на осуществление комплексных преобразований, мы помогаем им меняться, расти, развивать новые конкурентные преимущества и добиваться устойчивых долгосрочных результатов. </p>
    ...
    <div class="container mx-auto">
      ...
      <ol class="mx-10 md:mx-20 mb-10 list-decimal">
        ...
        <li class="consulting-list-item">Управление инвестициями в краткосрочной, среднесрочной и долгосрочной перспективе</li>
    ...
    <div class=" container mx-auto">
      ...
      <ol class="mx-10 md:mx-20 mb-10 list-decimal">
        ...
        <li class="consulting-list-item">Проработка всех рисков и их сравнительная оценка </li>
        <li class="consulting-list-item">Бизнес план </li>
    ...
    <div class=" container mx-auto">
      ...
      <ol class="mx-10 md:mx-20 mb-10 list-decimal">
        ...
        <li class="consulting-list-item">Консалтинг по всем аспектам организации управления </li>
        <li class="consulting-list-item">Разработка методики мониторинга реализации работ </li>
        <li class="consulting-list-item">Правовое сопровождение </li>
      </ol>
    </div>
    ...
    <div class=" container mx-auto">
      ...
      <ol class="mx-10 md:mx-20 mb-10 list-decimal">
        ...
        <li class="consulting-list-item">Управление бизнесом </li>
          <ul>
           <li class="consulting-list-item-child">Консалтинг в области франчайзинга</li>
          </ul>
        <li class="text-lg pt-5 pb-2">Бизнес-планирование </li>
        <ul>
         <li class="consulting-list-item-child">Разработка бизнес-плана </li>
         <li class="consulting-list-item-child">Анализ и корректировка готовых бизнес-планов </li>
         <li class="consulting-list-item-child">Разработка маркетингового плана </li>
         <li class="consulting-list-item-child">Финансовое моделирование </li>
         <li class="consulting-list-item-child">Производственный план, план производства </li>
         <li class="consulting-list-item-child">Организационный план </li>
        </ul>
      </ol>
    </div>
    ...
    <div class=" container mx-auto">
      ...
      <ol class="mx-10 md:mx-20 mb-10 list-decimal">
        ...
        <li class="consulting-list-item">Оптимизация деятельности предприятия / компании </li>
          <ul>
           <li class="consulting-list-item-child">Оптимизация / реинжиниринг бизнес процессов компании </li>
           <li class="consulting-list-item-child">Оптимизация взаимодействия подразделений компании </li>
           <li class="consulting-list-item-child">Оптимизация информационных процессов </li>
           <li class="consulting-list-item-child">Оптимизация системы внутреннего контроля </li>
           <li class="consulting-list-item-child">Оптимизация управленческой структуры предприятия </li>
           <li class="consulting-list-item-child">Управление производством </li>
           <li class="consulting-list-item-child">Управление продажами, управление дебиторской задолженностью </li>
           <li class="consulting-list-item-child">Управление запасами, транспортная и складская логистика </li>
           <li class="consulting-list-item-child">Управление сбытом </li>
          </ul>
      </ol>
    </div>
